...
Stacked Figure
```{r}
meltedDat <- melt(subset(All, select = c(Region, Treatment, style_length, stamen_length, ovule_number, germ, PD_mean, viable_seed)), id.var= c("Region", "Treatment"))

lables <- c(style_length = "Style + Stigma Length (mm)", stamen_length = "Anther Length (mm)", ovule_number = "Ovule Number", germ = "Pollen Germination", PD_mean = "Mean Pollen Diameter (µm)", viable_seed = "Viable Seed Count")
