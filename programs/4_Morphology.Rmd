...
lables <- c(style_length = "Style and Stigma Length", stamen_length = "Stamen Length")
...
ggplot(Iden_Mean, aes(x = Treatment, y = style.stamen, fill = Treatment)) +
  geom_boxplot(alpha = 0.8) +
  labs(y = "Style and Stigma Length to Stamen Length Ratio")+
  scale_fill_manual(values = c("#474747", "#FF3030")) +
  HStheme() +
  theme(legend.position = "none")
...
ggplot(Iden_Mean, aes(x = style_length, y = stamen_length, color = Treatment)) +
  ...
  labs(x = "Mean Style and Stigma Length", y = "Mean Stamen Length")
