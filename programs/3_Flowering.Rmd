...
```{r}
# First Flower
firstFlower.m <- lmer(DOY_flower1 ~ Region + (1|Population:ID), data = flower)
...
# Flower Type
# Chi-squared test
MH_flowerType <- data.frame(flower$Region, flower$Treatment, flower$Flower_Type) %>% 
  na.omit()

mantelhaen.test(x = flower$Region, z = flower$Treatment, y = flower$Flower_Type, exact=FALSE)
