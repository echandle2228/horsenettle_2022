...
Stacked Figure
```{r}
meltedDat <- melt(subset(All, select = c(Region, Treatment, style_length, stamen_length, PD_mean, ovule_number, viable_seed, unfertilized_ovules, aborted_seed)), id.var= c("Region", "Treatment"))

lables <- c(style_length = "Style + Stigma Length (mm)", stamen_length = "Anther Length (mm)",  PD_mean = "Mean Pollen Diameter (µm)", ovule_number = "Ovule Count", unfertilized_ovules = "Unfertilized Ovules", viable_seed = "Viable Seed Count", aborted_seed = "Aborted Seed Count")
...
```{r}
meltedDat2 <- melt(subset(All, select = c(Region, Treatment, style_length, stamen_length, ovule_number, unfertilized_ovules, aborted_seed)), id.var= c("Region", "Treatment"))

lables2 <- c(style_length = "Style + Stigma Length (mm)", stamen_length = "Anther Length (mm)", ovule_number = "Ovule Count", unfertilized_ovules = "Unfertilized Ovule Count", aborted_seed = "Aborted Seed Count")
...
# Saving graph
ggsave("figures/StackedPP.png", width = 8.25, height = 6, dpi = 300)
```
